...
class IntegerSetterGetter extends Thread {
    ...
    private void getIntegersFromResource() throws InterruptedException {
        ...
        synchronized (resource) {
            ...
            if (number == null)
                System.out.println("Поток " + getName() + " не смог извлечь число и прекращзает итерацию.");
            else System.out.println("Поток " + getName() + " извлек число " + number);
        }
    }
